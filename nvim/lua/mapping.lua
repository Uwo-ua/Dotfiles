...
map('n', '<F3>', ':so ~/.config/nvim/init.lua<CR>:so ~/.config/nvim/lua/plugins.lua<CR>:so ~/.config/nvim/lua/setting.lua<CR>:so ~/.config/nvim/lua/mapping.lua<CR>:so ~/.config/nvim/lua/lsp.lua<CR>:so ~/.config/nvim/lua/tabline.lua<CR>:so ~/.config/nvim/lua/treesitter.lua<CR>', { noremap = true })
